...
from stairwell_openapi_client.models.yara_rule import YaraRule  # noqa: E501
...
class TestYaraRule(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> YaraRule:
        """Test YaraRule
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YaraRule`
        """
        model = YaraRule()  # noqa: E501
        if include_optional:
            return YaraRule(
                name = '',
                definition = '',
