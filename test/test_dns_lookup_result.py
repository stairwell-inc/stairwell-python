...
from stairwell_openapi_client.models.dns_lookup_result import DNSLookupResult  # noqa: E501

class TestDNSLookupResult(unittest.TestCase):
    """DNSLookupResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DNSLookupResult:
        """Test DNSLookupResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DNSLookupResult`
        """
        model = DNSLookupResult()  # noqa: E501
        if include_optional:
