...
```sh
pip install git+https://github.com/stairwell-inc/stairwell-python
```
...
*ThreatReportsApi* | [**threat_reports_create_threat_report**](docs/ThreatReportsApi.md#threat_reports_create_threat_report) | **POST** /v1/environments/{environment}/threatReports | CreateThreatReport
*ThreatReportsApi* | [**threat_reports_delete_threat_report**](docs/ThreatReportsApi.md#threat_reports_delete_threat_report) | **DELETE** /v1/environments/{environment}/threatReports/{threatReport} | DeleteThreatReport
*ThreatReportsApi* | [**threat_reports_list_threat_report_iocs**](docs/ThreatReportsApi.md#threat_reports_list_threat_report_iocs) | **GET** /v1/environments/{environment}/threatReports/{threatReport}/iocs | ListThreatReportIocs
*ThreatReportsApi* | [**threat_reports_list_threat_report_matches**](docs/ThreatReportsApi.md#threat_reports_list_threat_report_matches) | **GET** /v1/reportEnvs/{reportEnv}/objEnvs/{objEnv}/threatReports/{threatReport}/matches | ListThreatReportMatches
*TriggersServiceApi* | [**triggers_service_list_trigger_matches**](docs/TriggersServiceApi.md#triggers_service_list_trigger_matches) | **GET** /v1/environments/{environment}/triggerMatches | ListTriggerMatches
...
## Documentation For Models
 ...
 - [ListThreatReportIocsResponse](docs/ListThreatReportIocsResponse.md)
 - [ListThreatReportMatchesResponse](docs/ListThreatReportMatchesResponse.md)
 - [ListTriggerMatchesResponse](docs/ListTriggerMatchesResponse.md)
 ...
 - [Tag](docs/Tag.md)
 - [ThreatReport](docs/ThreatReport.md)
 - [ThreatReportIOC](docs/ThreatReportIOC.md)
 - [ThreatReportMatch](docs/ThreatReportMatch.md)
 - [TriggerMatch](docs/TriggerMatch.md)
 - [TriggerMatchCondition](docs/TriggerMatchCondition.md)
