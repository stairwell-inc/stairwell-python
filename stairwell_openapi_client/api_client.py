...
import stairwell_openapi_client.models
from stairwell_openapi_client import rest
from stairwell_openapi_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stairwell_openapi_client.models, klass)
