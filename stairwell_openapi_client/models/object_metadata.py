...
class ObjectMetadata(BaseModel):
    ...
    """
    name: Optional[StrictStr] = Field(None, description="The resource name of the object.")
    md5: Optional[StrictStr] = Field(None, description="md5 is the md5 hash signature of an object.")
    sha1: Optional[StrictStr] = Field(None, description="sha1 is the sha1 hash signature of an object.")
    sha256: Optional[StrictStr] = Field(None, description="sha256 is the sha256 hash signature of an object.")
    sha3256: Optional[StrictStr] = Field(None, description="sha3256 is the sha3_256 hash signature of an object.")
    size: Optional[StrictStr] = Field(None, description="size is the size of the file in bytes.")
    stairwell_first_seen_time: Optional[datetime] = Field(None, alias="stairwellFirstSeenTime", description="stairwell_first_seen_time is the timestamp at which an object was first observed by Stairwell.")
    tags: Optional[conlist(Tag)] = Field(None, description="Tags associated with this object. Currently only populated by GetObjectMetadata. Other endpoints returning objects omit this field.")
    detonation: Optional[ObjectDetonation] = None
    mal_eval: Optional[MalEval] = Field(None, alias="malEval")
    environments: Optional[conlist(StrictStr)] = Field(None, description="List of environments that this object has been seen within.")
    yara_rule_matches: Optional[conlist(StrictStr)] = Field(None, alias="yaraRuleMatches", description="Yara rule resource names which have matched on this object. If more than 1000 yara rule, the matches will be truncated.")
    network_indicators: Optional[NetworkIndicators] = Field(None, alias="networkIndicators")
    magic: Optional[StrictStr] = Field(None, description="Magic number as determined by yara rule based identification.")
    mime_type: Optional[StrictStr] = Field(None, alias="mimeType", description="MIME type as determined by yara rule based identification.")
    shannon_entropy: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="shannonEntropy", description="Measure of the information contained in a object as opposed to the portion of the object that is determined (or predictable).")
    imphash: Optional[StrictStr] = Field(None, description="The Mandiant import hash (imphash) of the object.")
    imphash_sorted: Optional[StrictStr] = Field(None, alias="imphashSorted", description="The sorted import hash (imphash) of the object where the imports are sorted.")
    tlsh: Optional[StrictStr] = Field(None, description="The TLSH of the object, see https://github.com/trendmicro/tlsh")
    object_signature: Optional[ObjectSignature] = Field(None, alias="objectSignature")
