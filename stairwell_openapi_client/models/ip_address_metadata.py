...
class IpAddressMetadata(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IpAddressMetadata:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IpAddressMetadata:
        """Create an instance of IpAddressMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IpAddressMetadata.parse_obj(obj)

        _obj = IpAddressMetadata.parse_obj({
            "name": obj.get("name"),
