...
class ListTagsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTagsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTagsResponse:
        """Create an instance of ListTagsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTagsResponse.parse_obj(obj)

        _obj = ListTagsResponse.parse_obj({
